...
import { Plus, LayoutGrid, Trash2, FolderOpen, Sun, Moon, MoreHorizontal, Edit2, Share2, Upload, X, ChevronRight, Check, LogOut, StickyNote } from 'lucide-react';
        ...
        <header className="mb-12 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              title="메모"
            >
              <StickyNote className="h-4.5 w-4.5 text-foreground/70" />
            </button>
            <button
              onClick={onLogout}
              className="flex h-10 w-10 items-center justify-center rounded-full bg-card/50 border border-border shadow-sm transition-all hover:bg-card active:scale-95"
